 ...
 *   "expiresIn": 1579729529,
 *   "issuedTokenType": "urn:ietf:params:oauth:token-type:refresh_token",
 *   "refreshToken": " *  Example removed because github hates secrets,
 *   "scope": [
 *     "openid",
 *     "aws",
 *     "sts:identity_context"
 ...
 * ```
 *
 * @example  *  Example removed because github hates secrets
 * ```javascript
 * //
 * const input = {
 *  Example removed because github hates secrets
 * };
 * const command = new CreateTokenWithIAMCommand(input);
 * const response = await client.send(command);
 * /* response ==
 * {
 *   "accessToken":  *  Example removed because github hates secrets
 *   "scope": [
 *     "openid",
 *     "aws",
 *     "sts:identity_context"
 ...
 * {
 *   "accessToken":  *  Example removed because github hates secrets
 *   "issuedTokenType":  *  Example removed because github hates secrets,
 *   "scope": [
 *     "openid",
 *     "aws",
 *     "sts:identity_context"
